...
export const Section4 = () => {
    return <div style={{backgroundImage: 'url("/Section4Background.png")'}} className="bg-scroll bg-black bg-center bg-no-repeat">
        <div className="gap-12 flex flex-col justify-center text-center pb-12">
            <div className="flex flex-col gap-3 justify-center">
                ...
                <div className="text-[#E0E0E0] text-[24px] font-satoshi md:mx-32 lg:mx-48 text-center mt-4">
